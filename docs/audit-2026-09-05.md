...
Este informe conserva las mediciones de la primera publicación de la renovación, anterior a la recuperación del movimiento. La actualización posterior con Lenis, carruseles y corazones se documenta en [motion-2026-09-05.md](motion-2026-09-05.md).
...
| Medición                         |     Antes | Primera publicación |
| -------------------------------- | --------: | ------------------: |
| Rendimiento                      |        65 |                 100 |
...
- Fuentes locales WOFF2 y CSS propio. Se retiraron inicialmente GSAP, ScrollTrigger, Lenis y el router cliente; Lenis y la personalidad animada del festival se recuperaron en la actualización posterior indicada arriba.
